                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs">
                                        {[
                                            ...
                                            { icon: Shield, color: 'text-emerald-500', label: 'Privacy-safe', items: ['No cookies set', 'No IP addresses stored', 'Pseudonymous visitor ID only', 'Respects DNT & GPC signals', '~5.9 KB gzipped'] },
