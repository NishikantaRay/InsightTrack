...
- Name: dashboard/analytics-sections.spec.ts >> Content (/content) >> renders heading and content analytics
- Location: tests/dashboard/analytics-sections.spec.ts:81:3

# Error details

```
Error: The accessibility snapshot and current URL do not show any heading with the text 'Content Analytics' or 'Content'. Multiple headings are present, but none match or closely relate to 'Content Analytics' or 'Content'.
