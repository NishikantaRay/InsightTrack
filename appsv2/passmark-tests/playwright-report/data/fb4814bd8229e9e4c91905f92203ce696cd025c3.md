...
```
Error: The accessibility snapshot and current URL do not show any heading with the text 'Documentation' or 'Docs'. Multiple headings are present, but none match or imply 'Documentation' or 'Docs'. Therefore, the assertion that such a heading is visible fails.
