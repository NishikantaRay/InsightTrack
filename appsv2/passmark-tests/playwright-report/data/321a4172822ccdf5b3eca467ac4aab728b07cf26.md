...
- Name: dashboard/funnels.spec.ts >> Funnels — conversion funnel builder >> user can add a funnel step
- Location: tests/dashboard/funnels.spec.ts:45:3
...
```
Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open '/Users/nishikantaray/Desktop/Personal/traffic2/appsv2/passmark-tests/test-results/.playwright-artifacts-35/traces/cee5de2df21b36c7b935-b68853f129ced4a409bd-retry1-recording1.trace'
```
