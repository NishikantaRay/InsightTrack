...
```
Error: The accessibility snapshot of the current page at URL http://localhost:4173/landing does not contain any heading with the text 'Acquisition' or a similar term. Multiple headings are present, but none match or imply 'Acquisition'. Therefore, the assertion that an 'Acquisition' heading is visible should fail.
