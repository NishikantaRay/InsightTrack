...
```
Error: The accessibility snapshot and current URL do not show any heading containing the text 'Conversions' or 'Conversions & Funnels'. There is a heading 'Conversion Funnels' at level 3, but it does not exactly match 'Conversions' or 'Conversions & Funnels'. Given the assertion wording and the snapshot, the assertion should not pass.
