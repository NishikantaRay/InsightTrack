...
- Name: dashboard/settings.spec.ts >> Settings — site configuration >> site manager section lists the current site
- Location: tests/dashboard/settings.spec.ts:78:3
...
```ts
  1   | /**
  2   |  * tests/dashboard/settings.spec.ts
  3   |  * Passmark AI-powered tests for the Settings page (/settings).
  4   |  */
