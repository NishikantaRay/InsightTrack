...
```
Error: The accessibility snapshot and current URL do not show any heading or section labeled 'Privacy & Compliance' or 'Privacy'. Although there is a heading 'Privacy-First' at level 3, it is part of a feature description rather than a dedicated 'Privacy' or 'Privacy & Compliance' section or heading. Therefore, the assertion that a 'Privacy & Compliance' or 'Privacy' heading is visible does not pass with high confidence.
