...
// GET /api/sites - Get sites for authenticated user
...
// GET /api/sites/:siteId/script - Serve tracking script as raw JavaScript
...
// GET /api/sites/:siteId/snippet - Get tracking snippet HTML for copy/paste
